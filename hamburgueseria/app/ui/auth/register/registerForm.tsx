...
export default function RegisterForm() {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full gap-2 mt-24 mb-24  ">

            <form onSubmit={onSubmit} className="flex flex-col justify-items-center gap-2 flex-1 rounded-lg bg-gray-50 px-6 pb-4  text-black">
                ...
                <input type="text" {
                    ...
                    className="peer block w-full rounded-md border border-gray-200 py-[9px] pl-2 pr-10 text-sm outline-2 placeholder:text-gray-500 bg-slate-200"
                />
            ...
            <Link href="/auth/login" className=' text-sm hover:text-yellow-500'> Ya sos parte de la familia? Logeate </Link>
        </div>
