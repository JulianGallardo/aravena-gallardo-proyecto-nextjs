                ...
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        </div>
                        {
                            ...
                            <div>
                                <ul tabIndex={0} className={`menu menu-sm dropdown-content mt-3  p-2 shadow bg-lightgrey text-black rounded-box w-60 ${isClosing ? "animate-slide-up" : "animate-slide-down"}`}>
