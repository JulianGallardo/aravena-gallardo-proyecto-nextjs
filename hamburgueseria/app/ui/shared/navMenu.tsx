...
const NavMenu: React.FC = () => {
    ...
    const navbarClass = `navbar bg-brown fixed top-0 left-0 right-0 z-50 ${isTop ? 'bg-transparent' : ''}`;
            ...
            <div className={navbarClass}>
                <div className="navbar-start">
                    <div className="dropdown">
                        <div tabIndex={0} role="button" className="btn btn-ghost bg-pastel btn-circle">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-pastel rounded-box w-52">
