                    ...
                    <form action={
                        ...
                        <div className="flex flex-col text-sm text-lightgrey gap-2 md:grid grid-cols-2">
                            ...
                            <div>
                                ...
                                <input className="peer block w-full rounded-md border border-gray-200 py-[9px] pl-2 pr-10 text-sm outline-2 placeholder:text-gray-500" type="text" placeholder={session.user?.fullName || ''} />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input className="peer block w-full rounded-md border border-gray-200 py-[9px] pl-2 pr-10 text-sm outline-2 placeholder:text-gray-500" type="text" placeholder={session.user?.city || ''} />
                            </div>
                            <div>
                                <label className="mb-3 mt-5 block text-xs font-medium">Telefono:</label>
                                <input className="peer block w-full rounded-md border border-gray-200 py-[9px] pl-2 pr-10 text-sm outline-2 placeholder:text-gray-500" type="text" placeholder={session.user?.cellphone || ''} />
                            </div>
                            <div>
                                <label className="mb-3 mt-5 block text-xs font-medium">Direccion:</label>
                                <input className="peer block w-full rounded-md border border-gray-200 py-[9px] pl-2 pr-10 text-sm outline-2 placeholder:text-gray-500" type="text" placeholder={session.user?.address || ''} />
                            </div>
                        ...
                        <button type="submit"  className="bg-dark text-white px-4 py-2 rounded-md hover:bg-darkblue">Guardar</button>
                    </form>
                ) : (
